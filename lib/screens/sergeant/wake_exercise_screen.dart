...
/// Wake-alarm exercise flow, two-phase:
///
///   1. SETUP  — 5-second countdown with a HUGE on-screen brief:
///               "PHONE ON THE FLOOR. STAND BACK. FULL BODY IN FRAME."
///   2. REPS   — hands off to ExerciseCircuitScreen (camera + pose
///               detection), which runs its own inner countdown and
///               counts the user's chosen mission with escalating debt.
///
/// The intro drill-sergeant video was removed — asset was large and
/// crashed the app on some devices (memory spike as VideoPlayer +
/// camera pipeline compete for GPU). The audio siren + haptics from
/// MorningAlarmScreen carry through, so pressure stays on.
